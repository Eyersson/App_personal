...
ventana_principal.title("App de Chelo")
...
titulo = Label(frame_entrada, text="Eyersson Bercelly")
titulo.config(bg="white", fg="blue", font=("Helvetica", 25))
titulo.place(x=230, y=30)

titulo2 = Label(frame_entrada, text= "constancia ante todo.")
titulo2.config(bg="white", fg="black", font=("Verdana", 14))
titulo2.place(x=198, y=80)

logo = PhotoImage(file="img/chelito.png")
lb_logo = Label(frame_entrada, image=logo, bg="white")
lb_logo.place(x=70, y=10)

logito = PhotoImage(file="img/logito (1).png")
lb_logito = Label(frame_entrada, image=logito, bg="white")
lb_logito.place(x=460, y=70)

amigos = PhotoImage(file="img/WhatsApp.png")
lb_amigos = Label(frame_entrada, image=amigos, bg="white")
lb_amigos.place(x=150, y=70)
